...
export async function POST(request) {
  ...
  try {
    // Query the current number of items in query
    const itemCount = await query.countDocuments();
    ...
    const newItem = await query.create(data);
...
export async function DELETE(request) {
  ...
  try {
    ...
    const deletedItem = await query.findByIdAndDelete(id);
